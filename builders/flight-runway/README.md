...
```shell
$ bin/omnibus build flight-runway
```
...
```shell
$ bin/omnibus clean flight-runway
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/flight-runway`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean flight-runway --purge
```
...
[vagrant@ubuntu...] $ cd flight-runway
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ ...
[vagrant@ubuntu...] $ bin/omnibus build flight-runway
```
