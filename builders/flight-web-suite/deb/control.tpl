...
Depends:      flight-console-api (>= 2.1.0), flight-console-api (<< 2.2.0),
  ...
  flight-desktop-restapi (>= 2.1.0), flight-desktop-restapi (<< 2.2.0),
  ...
  flight-job-script-api (>= 1.1.0), flight-job-script-api (<< 1.2.0),
  flight-job-script-webapp (>= 1.1.0), flight-job-script-webapp (<< 1.2.0)
