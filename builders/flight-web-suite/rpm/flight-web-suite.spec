...
Requires:       flight-console-webapp => 1.7.0~, flight-console-webapp < 1.8.0~
Requires:       flight-desktop-restapi => 2.7.0~, flight-desktop-restapi < 2.8.0~
Requires:       flight-desktop-webapp => 1.9.0~, flight-desktop-webapp < 1.10.0~
Requires:       flight-file-manager-api => 1.6.0~, flight-file-manager-api < 1.7.0~
Requires:       flight-file-manager-webapp => 1.6.0~, flight-file-manager-webapp < 1.7.0~
Requires:       flight-login-api => 1.2.1, flight-login-api < 1.3.0~
Requires:       flight-job-script-api => 1.9.0~, flight-job-script-api < 1.10.0~
Requires:       flight-job-script-webapp => 1.9.0~, flight-job-script-webapp < 1.10.0~
Requires:       flight-www => 1.7.0~, flight-www < 1.8.0~
Requires:       flight-headnode-landing-page < 1.8.0~
