...
require 'json'
if File.exist?('/opt/flight/opt/job-script-webapp/build/config.json')
  json = File.read('/opt/flight/opt/job-script-webapp/build/config.json')
...
File.write('/opt/flight/opt/job-script-webapp/build/config.json', new_json)
EOF
}
