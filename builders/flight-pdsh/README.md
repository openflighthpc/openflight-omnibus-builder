...
```shell
$ bin/omnibus clean flight-pdsh
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/flight-pdsh`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean flight-pdsh --purge
```
...
[vagrant@ubuntu...] $ cd flight-pdsh
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ ...
[vagrant@ubuntu...] $ bin/omnibus build flight-pdsh
```
