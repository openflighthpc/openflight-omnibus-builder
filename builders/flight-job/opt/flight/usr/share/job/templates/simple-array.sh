#!/bin/bash -l
#@          flight_JOB[name]: Simple serial array (Slurm)
#@          flight_JOB[desc]: Submit multiple, similar jobs. Each job will be allocated a single core on the first available node.
